...
stopwords_common = {
    ...
    '우려',
    # 긴장: "중동 긴장", "K-바이오 긴장", "SK그룹 긴장" 등 서로 무관한 기사에 흩어지는 분산 상태어
    '긴장',
    ...
    '필요', '개선', '마비', '신고',
    # 발언: 정치·스포츠 등 여러 카테고리에서 "누군가 발언" 형태로 분산되는 행위명사 — 발표와 같은 이유
    '발언',
    ...
    '소리',
    # 최초: "한국 투수 최초", "역사상 최초" 등 역대·사상·최대·최고와 같은 최상급 수식어 — 단독 키워드 가치 없음
    '최초',
}
