  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white">
      <main id="main-content" tabIndex={-1} className="max-w-lg mx-auto px-4 py-6">
        ...
        {description && (
          <div className="mb-6 border-l-2 border-orange-300 dark:border-orange-800 pl-3.5">
        ...
        {articles.length > 0 && (
          <section className="mb-8">
            ...
            <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm dark:shadow-none px-4 py-3 flex flex-col gap-3">
              {articles.map((article, idx) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-zinc-700 dark:text-zinc-200 text-sm leading-snug group-hover/link:text-orange-700 dark:group-hover/link:text-orange-400 transition-colors break-keep">
